...
public class Component implements Asset {
    ...
    public Component(String name, int posX, int posY, int posZ, LocalDate inspectionDate, double price) {
        this.name = name;
        this.posX = posX;
        this.posY = posY;
        this.posZ = posZ;
